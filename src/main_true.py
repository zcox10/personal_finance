...
def run_financial_accounts(data, context):
...
def run_plaid_transactions(data, context):
...
def run_plaid_investments(data, context):
...
def run_delete_tables(data, context):
...
if __name__ == "__main__":
    run_financial_accounts("data", "context")
